...
const OpenClawTechComparison: React.FC = () => {
    const data = [
        ...
        { tech: 'ChatGPT', model: 'Web / App', scope: 'Cloud Only', state: 'Cloud memory', color: '#94a3b8' }
    ];
    ...
    return (
        <div className="not-readable" style={{
            ...
            <div style={{ padding: '32px', background: 'rgba(255, 255, 255, 0.02)', borderBottom: '1px solid rgba(255, 255, 255, 0.05)' }}>
                <h3 style={{ margin: 0, color: '#f8fafc', fontSize: '20px', fontWeight: '800' }}>Platform Comparison: Interaction & State</h3>
                <p style={{ margin: '8px 0 0', color: '#94a3b8', fontSize: '13px' }}>How OpenClaw differs from traditional AI frameworks and workflow tools.</p>
            </div>
                    ...
                    <tbody>
                        {data.map((row, idx) => (
                            <tr key={idx} style={{
                                ...
                                <td style={{ padding: '20px', color: '#cbd5e1', fontSize: '13px' }}>{row.model}</td>
                                <td style={{ padding: '20px', color: '#cbd5e1', fontSize: '13px' }}>{row.scope}</td>
                                <td style={{ padding: '20px' }}>
                                    <span style={{
