...
Copilot is autocomplete. Codex is autonomous. Copilot suggests the next line. Codex builds entire features while you're offline.

### Can I use Codex with my existing projects?
Yes. Connect your GitHub repo, add an `AGENTS.md` file with your project rules, and start queuing tasks.

### Does Codex work on Windows or Linux?
Currently macOS only. Windows and Linux versions are "coming soon" according to OpenAI.

### What happens if the agent makes a mistake?
All changes go through Pull Requests. Your main branch is never touched directly. Review, approve, or reject just like any human contributor.

### Is this going to replace developers?
No. It shifts developers from implementation to architecture and orchestration. You become a "conductor" managing an agent orchestra rather than playing every instrument yourself.
